...
INTERVIEW_QUESTION_TARGET_MIN = 5
INTERVIEW_QUESTION_TARGET_MAX = 6
INTERVIEW_QUESTION_NORMAL_CAP = 8
INTERVIEW_QUESTION_ABSOLUTE_CAP = 10
if not (
    4
    <= INTERVIEW_QUESTION_TARGET_MIN
    <= INTERVIEW_QUESTION_TARGET_MAX
    <= INTERVIEW_QUESTION_NORMAL_CAP
    < INTERVIEW_QUESTION_ABSOLUTE_CAP
):
    raise ValueError("Interview 질문 수 설정이 올바르지 않습니다.")
