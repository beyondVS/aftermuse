...
def test_project_root_dotenv_is_loaded_without_cli_injection(tmp_path) -> None:
    ...
    shutil.copytree("src/knowledge", project_source / "knowledge")
    shutil.copytree("src/readings", project_source / "readings")
    shutil.copytree("src/reflections", project_source / "reflections")
