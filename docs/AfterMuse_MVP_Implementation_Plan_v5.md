...
- [x] **IMP-025 — 도서 Metadata Provider 교체 및 검색 복구**
  ...
  - **검증 (2026-09-06):** Kakao Adapter·회귀 테스트, 기본 자동 검증과 실제 `KAKAO_REST_API_KEY`를 사용하는 명시적 `live` smoke를 통과했다.
...
- [x] **IMP-024 — 도서 선택 및 로컬 Book 등록**
  ...
  - **검증 (2026-09-06):** session 후보 ID·CSRF POST·기존 Book 재사용·동시 선택의 PostgreSQL 회귀 테스트를 통과했다.
