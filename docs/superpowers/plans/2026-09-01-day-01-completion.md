...
- [x] **Step 2: Day 01 밖의 Django app이 생성되지 않았는지 확인**
...
- [x] **Step 1: 도구 및 framework version 기록**
...
- [x] **Step 3: 격리 worktree의 local 환경파일 준비**
...
- [x] **Step 5: local vendor asset과 license 확인**
...
- [x] **Step 1: 검증용 host port가 비어 있는지 확인**
...
- [x] **Step 2: 현재 Compose project와 volume 대상을 읽기 전용으로 기록**
...
- [x] **Step 3: process 범위의 검증 환경변수 설정**
...
- [x] **Step 4: 별도 Compose project와 새 volume 시작**
...
- [x] **Step 5: migration 적용 전 빈 상태 확인**
...
- [x] **Step 6: Django 기본 migration을 처음부터 적용**
...
- [x] **Step 7: migration 적용 상태와 system check 확인**
...
- [x] **Step 8: 검증 환경 cleanup 대상을 확인하고 승인 요청**
...
- [x] **Step 1: 기존 개발 DB container 상태 확인**
...
- [x] **Step 3: 검증 스크립트 fail-fast 계약 확인**
...
- [x] **Step 2: HTTP와 CSP baseline 확인**
...
- [x] **Step 5: Alpine.js CSP 상태 전환 검증**
...
- [x] **Step 3: README와 CHANGELOG의 사실성 확인**
