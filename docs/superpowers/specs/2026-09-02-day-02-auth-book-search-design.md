...
> **2026-09-02 실행 범위 변경:** 현재 브랜치에서는 IMP-010 최소 사용자 인증만
> 구현·검증한다. IMP-020, IMP-021, IMP-022, IMP-023과 아래 Book/Provider/Search
> 설계는 후속 작업을 위한 승인된 설계로 보존하지만 이번 실행에서는 구현하지 않는다.
